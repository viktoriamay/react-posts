      ...
      {currentUser ? (
        <div className="profile">
          ...
          <Form
            ...
            />
            {errors.avatar && <span className='form__errors profile_form__errors'>{errors?.avatar?.message}</span>}
            </div>
          ...
          <Form
            ...
            />
            {errors.name && <span className='form__errors profile_form__errors'>{errors?.name?.message}</span>}
            </div>
            <div className='profile__input_block'>
            ...
            />
            {errors.about && <span className='form__errors profile_form__errors'>{errors?.about?.message}</span>}
            </div>
